...
public class StartGameScenario extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("StartGameScenario")
    .exec(
      http("request_0")
        .post("/game/25e9059c-e993-4d79-a921-cd2eda8a70db/start")
        .headers(headers_0)
        .resources(
          http("request_1")
