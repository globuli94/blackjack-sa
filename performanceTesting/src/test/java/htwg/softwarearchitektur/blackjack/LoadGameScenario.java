...
public class LoadGameScenario extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("LoadGameScenario")
    .exec(
      http("request_0")
        .post("/game/25e9059c-e993-4d79-a921-cd2eda8a70db/load")
        .headers(headers_0)
        .resources(
          http("request_1")
