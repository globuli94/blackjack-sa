...
public class BetAndPlayScenario extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("BetAndPlayScenario")
    .exec(
      http("request_0")
        .post("/game/25e9059c-e993-4d79-a921-cd2eda8a70db/bet/100")
        .headers(headers_0)
        .resources(
          http("request_1")
      ...
      pause(7),
      http("request_8")
        .post("/game/25e9059c-e993-4d79-a921-cd2eda8a70db/hit")
        .headers(headers_0)
        .resources(
          http("request_9")
            .get("/game/25e9059c-e993-4d79-a921-cd2eda8a70db/state")
